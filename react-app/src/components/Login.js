...
const Login = () => {
    ...
    const { username, setName, room, setRoom } = useContext(MainContext)
    ...
    return (
        <Flex className='login' flexDirection='column' mb='8'>
            ...
            <Flex className="form" gap='1rem' flexDirection={{ base: "column", md: "row" }}>
                <Input variant='filled' mr={{ base: "0", md: "4" }} mb={{ base: "4", md: "0" }} type="text" placeholder='User Name' value={username} onChange={e => setName(e.target.value)} />
